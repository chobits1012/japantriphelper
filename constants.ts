...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
      ...
      accommodation: { name: "京都 XX 飯店", checkIn: "22:00" },
      events: [
          { time: "15:40", title: "TPE 起飛", desc: "桃園第一航廈", category: 'flight', mapQuery: "Taoyuan International Airport" },
          ...
          { time: "22:00", title: "Check-in", desc: "京都 XX 飯店", category: 'hotel', mapQuery: "Kyoto Station" }
      ]
  },
  {
      id: "day-2",
  ...
  },
  {
      ...
      accommodation: { name: "伊根 XX 舟屋", checkIn: "15:00" },
      events: [
          ...
          { time: "15:00", title: "Check-in: 伊根 XX 舟屋", desc: "入住舟屋，體驗臨海而居", category: 'hotel', mapQuery: "Ine Funaya" },
  ...
  },
  {
      ...
      accommodation: { name: "城崎 XX 溫泉旅館", checkIn: "15:30" },
      events: [
          ...
          { time: "15:30", title: "Check-in: 城崎 XX 溫泉旅館", desc: "換上浴衣", category: 'hotel', mapQuery: "Kinosaki Onsen" },
  ...
  },
  {
      ...
      accommodation: { name: "岡山 XX 飯店", checkIn: "18:00" },
      events: [
          ...
          { time: "18:00", title: "Check-in: 岡山 XX 飯店", desc: "岡山站西口", category: 'hotel', mapQuery: "Okayama Station" },
  ...
  },
  {
      ...
      accommodation: { name: "京都 XX 飯店", checkIn: "16:00" },
      events: [
          ...
          { time: "16:00", title: "Check-in: 京都 XX 飯店", desc: "回到熟悉的京都飯店", category: 'hotel', mapQuery: "Kyoto Station" }
      ]
  },
  {
      id: "day-8",
  ...
  },
  {
      ...
      accommodation: { name: "大阪 XX 飯店", checkIn: "12:30" },
      events: [
          { time: "11:00", title: "前往大阪", desc: "搭乘京阪電車或 JR", category: 'transport' },
          { time: "12:30", title: "Check-in: 大阪 XX 飯店", desc: "寄放行李", category: 'hotel', mapQuery: "Yodoyabashi Station" },
  ...
  },
  {
      ...
      events: [
          ...
          { time: "20:45", title: "起飛", desc: "返回台北", category: 'flight', mapQuery: "Kansai International Airport" },
