        ...
        {isHome && (
          <div className="flex items-center gap-5">
            <div className="flex flex-col items-center justify-center min-w-[60px] border-r border-gray-300 pr-4 dark:border-slate-600">
              <span className="text-2xl font-serif font-bold text-japan-blue dark:text-sky-400">
                {day.date.split('/')[1]}
              </span>
              <span className="text-xs text-gray-500 uppercase font-bold dark:text-slate-400">
                {day.weekday}
              </span>
            </div>
            <div className="flex-1 pr-12">
              <div className="flex items-center justify-between mb-1">
                <h3 className="font-serif font-bold text-xl text-ink dark:text-slate-100">
                  {day.title}
                </h3>
                {day.pass && (
                  <span
              ...
              <p className="text-sm text-gray-600 line-clamp-none dark:text-slate-300">
                {day.desc}
              </p>
            </div>
          </div>
