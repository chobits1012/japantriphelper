        ...
        <div className="p-8 space-y-6">
           ...
           <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full text-lg font-bold border-b-2 border-gray-200 focus:border-japan-blue outline-none py-2 text-ink placeholder-gray-300"
              />
           </div>
           ...
           <div className="space-y-2">
              ...
              <div className="grid grid-cols-4 gap-2">
                <button 
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-lg border-2 transition-all ${season === 'spring' ? 'border-pink-400 bg-pink-50 text-pink-500' : 'border-gray-100 text-gray-400 hover:border-pink-200'}`}
                >
                   <Flower2 size={20} />
                ...
                <button 
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-lg border-2 transition-all ${season === 'summer' ? 'border-orange-400 bg-orange-50 text-orange-500' : 'border-gray-100 text-gray-400 hover:border-orange-200'}`}
                >
                   <Sun size={20} />
                ...
                <button 
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-lg border-2 transition-all ${season === 'autumn' ? 'border-red-500 bg-red-50 text-red-500' : 'border-gray-100 text-gray-400 hover:border-red-200'}`}
                >
                   <Leaf size={20} />
                ...
                <button 
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-lg border-2 transition-all ${season === 'winter' ? 'border-sky-500 bg-sky-50 text-sky-500' : 'border-gray-100 text-gray-400 hover:border-sky-200'}`}
                >
                   <Snowflake size={20} />
           ...
           <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full text-lg font-mono font-bold border-b-2 border-gray-200 focus:border-japan-blue outline-none py-2 text-ink"
              />
           </div>
           ...
           <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                 <input 
                   ...
                   className="flex-1 accent-japan-blue h-2 bg-gray-100 rounded-lg appearance-none cursor-pointer"
                 />
                 <span className="text-2xl font-serif font-bold text-japan-blue w-12 text-center">
                    {duration}
                 </span>
           ...
           <button 
             ...
             className="w-full bg-japan-blue text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-japan-blue/90 hover:scale-[1.02] transition-all flex items-center justify-center gap-2 mt-4"
           >
