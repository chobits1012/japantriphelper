        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-japan-blue focus:border-transparent outline-none transition-all text-sm font-mono"
            />
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
               <button 
                  ...
                  className={`p-3 rounded-lg border text-sm font-bold flex items-center justify-center gap-2 transition-all ${targetDay === 'all' ? 'bg-japan-blue text-white border-japan-blue' : 'bg-gray-50 text-gray-600 border-gray-200 hover:bg-gray-100'}`}
               >
                  <CalendarRange size={16} />
               ...
               <select 
                  ...
                  className={`p-3 rounded-lg border text-sm font-bold outline-none transition-all ${targetDay !== 'all' ? 'bg-japan-blue text-white border-japan-blue' : 'bg-gray-50 text-gray-600 border-gray-200 hover:bg-gray-100'}`}
               >
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-japan-blue focus:border-transparent outline-none transition-all h-32 resize-none text-sm leading-relaxed"
            />
          </div>
